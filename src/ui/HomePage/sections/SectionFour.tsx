...
function SectionFour() {
    return (
        <section className="w-full px-2">
            <div
                className="langingpage-container px-2 lg:px-0 py-8 md:pt-0 flex flex-col md:flex-row gap-0 items-center border-x border-x-stone-800 md:border-b-0 border-b border-b-stone-800 "
            >
