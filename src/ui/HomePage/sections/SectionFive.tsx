...
function SectionFive() {
    return (
        <section className="w-full px-2">
            <div
                className="langingpage-container px-2 lg:px-0 py-8 md:py-0 flex flex-col-reverse md:flex-row gap-0 items-center border-x border-x-stone-400/50 dark:border-x-stone-800"
            >
