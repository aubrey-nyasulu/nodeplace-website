...
function Hero() {
  return (
    <section className="relative w-full h-fit overflow-hidden  z-40 px-2">
      <div className="langingpage-container px-4 lg:px-0 h-full flex flex-col items-start justify-center border-x border-x-stone-400/50 dark:border-x-stone-800 pt-40 pb-16">
        ...
        <div className="w-full md:max-w-[900px] text-center md:text-left mt-1 z-40 md:ml-8">
          <h1 className=" text-[40px] md:text-[64px] font-bold leading-[1.10] pb-1 md:pb-4  ">Where all edges connect</h1>
